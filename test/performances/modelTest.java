...
public class modelTest {
	...
	public static void setUpBeforeClass() {
		...
		try {
			writer = new FileWriter("target"+ File.separator +"output" + System.currentTimeMillis() + ".csv");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void test(int difficulty, int nbOfFlights, int run) {
		...
		CSPModel cSPModel = new CSPModel(planes, new int[] { 6, 5, 3, 3, 3, 4, 2, 1, 1 }, 1200, 30000);
